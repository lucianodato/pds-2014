%Version con escalado de Ventana

%Cargo los parametros
Fm = 300;
T = 1/Fm;
fact_df = 4; %Factor que aumenta la definicion frecuencial
...
Fil_vent = [Fil_vent zeros(1,fact_df*Fm - length(Fil_vent))];
